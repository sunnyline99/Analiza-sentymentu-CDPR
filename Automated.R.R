...
## Usuni璚ie retweet轑 oraz oganiczenie bazy tylko do niezb璠nych kolumn + zapis danych na dysku
...
## Wyb鏎 tweet轑 tylko z ostatnich 24 godzin + usuni璚ie duplikat闚
...
# Za豉dowanie bazy danych ze starymi danymi i przerobienie formatu daty + usuni璚ie duplikat轑
...
## Po章czenie nowej i starej bazy danych + zapis bazy na dysku
...
## Wyb鏎 tylko ostatniej godziny z bazy danych (analiza kr鏒kookresowa)
...
## Czyszczenie tekstu + analiza emotikon闚
...
## Czyszczenie danych ze zb璠nych znak闚
